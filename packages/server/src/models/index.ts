...
import { getAllPosts, findPostById, createPost, deletePost, updatePost, findPostsByAuthorId, findAdminPostsByAuthorId, getAdminAllPosts } from "./postsModel";
...
export default {
    ...
    "posts": {
        ...
        "adminGetPosts": getAdminAllPosts
    },
    "comments": {
        "get": getAllComments,
